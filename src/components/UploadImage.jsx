    ...
    return (
        ...
        <div className="type-input">
          ...
          {result ? (
            ...
            <svg aria-hidden="true" class="mx-auto mt-2 mr-2 w-8 h-8 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
